...
struct ExploreStatus_
{
  ...
  static const std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other> EXPLORATION_STARTED;
  static const std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other> EXPLORATION_IN_PROGRESS;
  static const std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other> EXPLORATION_PAUSED;
  static const std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other> EXPLORATION_COMPLETE;
  static const std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other> RETURNING_TO_ORIGIN;
  static const std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other> RETURNED_TO_ORIGIN;
